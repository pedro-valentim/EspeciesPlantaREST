...
public class REST{
	...
	public void especieGetPostPutDelete(){
		...
		delete("/especie/:nomecientifico/", new Route() {
	         @Override
	         public Object handle(Request request, Response response) {
	        	
	        	response.header("Access-Control-Allow-Origin", "*");
	        	 
	            String nomeCientifico = request.params(":nomecientifico").replaceAll("%20", " ");
	            
	            try {
	            	
	            	Boolean status = model.excluiEspeciePorNomeCientifico(nomeCientifico);
		...
		put("/especie/:nomecientifico/", new Route() {
	         @Override
	         public Object handle(Request request, Response response) throws UnsupportedEncodingException {
	            ...
	            try {
	            	...
	            	Especie especie = model.atualizaEspecie(request.queryMap());
